...
class PaymentMethodsControllerTest < ActionController::TestCase
  ...
  test "should create payment_method" do
    assert_difference('PaymentMethod.count') do
      post :create, payment_method: { account_id: @payment_method.account_id, method: @payment_method.method, status: @payment_method.status }
    end
  ...
  test "should update payment_method" do
    patch :update, id: @payment_method, payment_method: { account_id: @payment_method.account_id, method: @payment_method.method, status: @payment_method.status }
    assert_redirected_to payment_method_path(assigns(:payment_method))
  end
