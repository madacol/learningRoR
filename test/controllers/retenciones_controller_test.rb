...
class RetencionesControllerTest < ActionController::TestCase
  ...
  test "should create retencione" do
    assert_difference('Retencione.count') do
      post :create, retencione: { code_factura: @retencione.code_factura, description: @retencione.description, monto: @retencione.monto, razon_social_id_id: @retencione.razon_social_id_id, status: @retencione.status, type: @retencione.type }
    end
  ...
  test "should update retencione" do
    patch :update, id: @retencione, retencione: { code_factura: @retencione.code_factura, description: @retencione.description, monto: @retencione.monto, razon_social_id_id: @retencione.razon_social_id_id, status: @retencione.status, type: @retencione.type }
    assert_redirected_to retencione_path(assigns(:retencione))
  end
