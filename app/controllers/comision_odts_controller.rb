class ComisionOdtsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @comision_odt.save
        format.html { redirect_to comision_odts_url, success: @comision_odt.table_name_to_show.concat(' fue creada satisfactoriamente.') }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to comision_odts_url, success: 'Comision odt fue eliminado satisfactoriamente.' }
