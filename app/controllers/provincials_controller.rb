class ProvincialsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @provincial.save
        format.html { redirect_to provincials_url, notice: @provincial.table_name_to_show.concat(' was successfully created.') }
  ...
  def update
    respond_to do |format|
      if @provincial.update(provincial_params)
        format.html { redirect_to provincials_url, notice: @provincial.table_name_to_show.concat(' was successfully updated.') }
  ...
  def destroy
    @provincial.destroy
    respond_to do |format|
      format.html { redirect_to provincials_url, notice: @provincial.table_name_to_show.concat(' was successfully destroyed.') }
