class PaymentMethodsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @payment_method.save
        format.html { redirect_to payment_methods_url, success: 'El método de pago fue creado satisfactoriamente.' }
  ...
  def update
    respond_to do |format|
      if @payment_method.update(payment_method_params)
        format.html { redirect_to payment_methods_url, success: 'El método de pago fue actualizado satisfactoriamente.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to payment_methods_url, success: 'El método de pago fue eliminado satisfactoriamente.' }
  ...
  private
    ...
    def payment_method_params
      params.require(:payment_method).permit(:account_id, :method, :status)
    end
end
