class PoolsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @pool.save
        format.html { redirect_to @pool, notice: @pool.table_name_to_show.concat(' was successfully created.') }
  ...
  def update
    respond_to do |format|
      if @pool.update(pool_params)
        format.html { redirect_to @pool, notice: @pool.table_name_to_show.concat(' was successfully updated.') }
